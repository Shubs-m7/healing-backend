...
export const sendSchedulingLinkEmail = async (email: string, name: string, link: string) => {
    try {
        const mailOptions = {
            from: process.env.EMAIL_FROM,
            to: email,
...
export const sendAppointmentConfirmedEmail = async (email: string, name: string, date: string, time: string) => {
    try {
        const mailOptions = {
            from: process.env.EMAIL_FROM,
            to: email,
...
export const sendBookingConfirmationToClient = async (email: string, name: string) => {
    try {
        const mailOptions = {
            from: process.env.EMAIL_FROM,
            to: email,
...
export const sendRescheduleSuggestionEmail = async (email: string, name: string, date: string, selectedTime: string, suggestedTimes: string[], link: string) => {
    try {
        const mailOptions = {
            from: process.env.EMAIL_FROM,
            to: email,
